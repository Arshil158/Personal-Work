...
# Analysis object: /MC_JETS/jet_y_4
...
ax_yLabel = r'$\mathrm{d}\sigma/\mathrm{d}y(\mathrm{jet~4})$ [pb]'
ax_title  = r'Rapidity of fourth jet'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (-5.0, 5.0)
yLims = (0.11, 1.0)
...
exec(open(prefix+'jet_y_4__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'jet_y_4.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'jet_y_4.png'), format='PNG')
