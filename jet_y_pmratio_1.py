...
# Analysis object: /MC_JETS/jet_y_pmratio_1
...
ax_xLabel = r'$|y(\mathrm{jet~1}|$'
ax_yLabel = r'$y(\mathrm{jet~1})_+/y(\mathrm{jet~1})_-$'
ax_title  = r'Rapidity $+/-$ ratio of first jet'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.0, 5.0)
yLims = (0.11, 1.0)
...
exec(open(prefix+'jet_y_pmratio_1__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'jet_y_pmratio_1.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'jet_y_pmratio_1.png'), format='PNG')
