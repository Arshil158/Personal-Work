...
# Analysis object: /MC_JETS/jet_y_pmratio_3
...
ax_xLabel = r'$|y(\mathrm{jet~3}|$'
ax_yLabel = r'$y(\mathrm{jet~3})_+/y(\mathrm{jet~3})_-$'
ax_title  = r'Rapidity $+/-$ ratio of third jet'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.0, 5.0)
yLims = (0.11, 1.0)
...
exec(open(prefix+'jet_y_pmratio_3__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'jet_y_pmratio_3.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'jet_y_pmratio_3.png'), format='PNG')
