...
# Analysis object: /MC_JETS/jets_deta_23
...
ax_xLabel = r'$\Delta\eta(\mathrm{jet~2,~jet~3})$'
ax_yLabel = r'$\mathrm{d}\sigma/\mathrm{d}\Delta\eta(\mathrm{jet~2,~jet~3})$ [pb]'
...
exec(open(prefix+'jets_deta_23__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'jets_deta_23.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'jets_deta_23.png'), format='PNG')
