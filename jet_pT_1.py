...
# Analysis object: /MC_JETS/jet_pT_1
...
ax_xLabel = r'$p_\perp(\mathrm{jet~1})$ [GeV]'
ax_yLabel = r'$\mathrm{d}\sigma/\mathrm{d}p_\perp(\mathrm{jet~1})$ [pb/GeV]'
ax_title  = r'Transverse momentum of leading jet'
ax_xScale = 'log'
ax_yScale = 'linear'
xLims = (20.0, 3250.0)
yLims = (0.11, 1.0)
...
exec(open(prefix+'jet_pT_1__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'jet_pT_1.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'jet_pT_1.png'), format='PNG')
