...
# Analysis object: /MC_JETS/jet_pT_2
...
ax_xLabel = r'$p_\perp(\mathrm{jet~2})$ [GeV]'
ax_yLabel = r'$\mathrm{d}\sigma/\mathrm{d}p_\perp(\mathrm{jet~2})$ [pb/GeV]'
ax_title  = r'Transverse momentum of second jet'
ax_xScale = 'log'
ax_yScale = 'linear'
xLims = (20.0, 2166.667)
yLims = (0.11, 1.0)
...
exec(open(prefix+'jet_pT_2__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'jet_pT_2.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'jet_pT_2.png'), format='PNG')
