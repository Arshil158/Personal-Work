...
# Analysis object: /MC_JETS/jet_mass_3
...
ax_xLabel = r'$m(\mathrm{jet~3})$ [GeV]'
ax_yLabel = r'$\mathrm{d}\sigma/\mathrm{d}m(\mathrm{jet~3})$ [pb/GeV]'
ax_title  = r'Mass of third jet'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (1.0, 100.0)
yLims = (0.11, 1.0)
...
exec(open(prefix+'jet_mass_3__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'jet_mass_3.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'jet_mass_3.png'), format='PNG')
