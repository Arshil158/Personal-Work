...
# Analysis object: /MC_JETS/jet_pT_4
...
ax_xLabel = r'$p_\perp(\mathrm{jet~4})$ [GeV]'
ax_yLabel = r'$\mathrm{d}\sigma/\mathrm{d}p_\perp(\mathrm{jet~4})$ [pb/GeV]'
ax_title  = r'Transverse momentum of fourth jet'
ax_xScale = 'log'
ax_yScale = 'linear'
xLims = (20.0, 1300.0)
yLims = (0.11, 1.0)
...
exec(open(prefix+'jet_pT_4__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'jet_pT_4.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'jet_pT_4.png'), format='PNG')
