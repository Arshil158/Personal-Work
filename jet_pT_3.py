...
# Analysis object: /MC_JETS/jet_pT_3
...
ax_xLabel = r'$p_\perp(\mathrm{jet~3})$ [GeV]'
ax_yLabel = r'$\mathrm{d}\sigma/\mathrm{d}p_\perp(\mathrm{jet~3})$ [pb/GeV]'
ax_title  = r'Transverse momentum of third jet'
ax_xScale = 'log'
ax_yScale = 'linear'
xLims = (20.0, 1625.0)
yLims = (0.11, 1.0)
...
exec(open(prefix+'jet_pT_3__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'jet_pT_3.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'jet_pT_3.png'), format='PNG')
