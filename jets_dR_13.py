...
# Analysis object: /MC_JETS/jets_dR_13
...
ax_xLabel = r'$\Delta{R}(\mathrm{jet~1,~jet~3})$'
ax_yLabel = r'$\mathrm{d}\sigma/\mathrm{d}\Delta{R}(\mathrm{jet~1,~jet~3})$ [pb]'
...
exec(open(prefix+'jets_dR_13__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'jets_dR_13.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'jets_dR_13.png'), format='PNG')
